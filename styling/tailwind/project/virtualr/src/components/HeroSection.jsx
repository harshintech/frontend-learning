  ...
  return (
    <div className="flex flex-col items-center mt-2 lg:mt-2">
      ...
      <div className="flex justify-center my-10">
        <a
          href="#"
          className="bg-gradient-to-r from-violet-500 to-violet-800 py-3 px-4 mx-3 rounded-md"
        >
          Start for Free
        </a>
      ...
      <div className="flex mt-10 justify-center">
        <video
          ...
          loop
          muted
          className="rounded-lg w-1/2 border-2 border-violet-700 shadow-violet-400 mx-2 my-4"
        >
